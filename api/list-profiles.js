...
export default async function handler(req, res) {
    ...
    const fetchRes = await fetch(`${SUPABASE_URL}/rest/v1/rpc/admin_list_profiles`, {
        method: 'POST',
        headers: {
            'apikey': serviceKey,
    ...
    if (!fetchRes.ok) {
        ...
        console.error('list-profiles supabase rpc failed:', fetchRes.status, errText.slice(0, 400));
