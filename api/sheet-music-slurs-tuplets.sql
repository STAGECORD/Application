-- =====================================================================
-- STAGECORD — Sheet Music: slurs and triplets
-- Run in Supabase SQL editor, after api/sheet-music-dots.sql.
-- =====================================================================

ALTER TABLE public.sheet_music_notes
    ADD COLUMN IF NOT EXISTS slur boolean NOT NULL DEFAULT false;
ALTER TABLE public.sheet_music_notes
    ADD COLUMN IF NOT EXISTS tuplet_start boolean NOT NULL DEFAULT false;

-- Re-bundle get_sheet_music so notes include the new flags.
