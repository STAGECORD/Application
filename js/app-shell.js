...
(async function () {
    ...
    const NAV = [
        ...
        { label: 'Rhymes', href: '/rhymes/', help: 'Book of Rhymes — your private collection of lyric fragments. Categorize by song section (verse, chorus, bridge…) and optionally tag them to a project so you can find them when writing.', icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h12a4 4 0 0 1 4 4v12H8a4 4 0 0 1-4-4V4z"/><path d="M4 16h12"/><path d="M8 8h8M8 12h6"/></svg>`, artistOnly: true },
